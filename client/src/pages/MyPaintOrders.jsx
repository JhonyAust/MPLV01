...
const MyPaintOrders = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                const response = await fetch('/api/orders/mypaint-orders');
                if (!response.ok) {
    ...
    return (
        <div className="container mx-auto px-4 py-8 mt-10">
            <h1 className="text-xl font-bold my-4">My Panit Orders</h1>
