...
const PaintingServiceComponent = () => {
        ...
        <div className=" max-w-screen-lg flex flex-col md:mt-32 lg:mt-32">
          ...
          <div className={`flex ${isMobile ? 'flex-col ' : 'flex-row '} px-8  mb-8`}>
            ...
            <div className='flex flex-col  '>
              ...
              <div className={`grid grid-cols-4 gap-6 lg:-ml-8  w-full mt-12 mb-4`}>
              {iconData.map((item, index) => (
                <div key={index} className="flex flex-col items-center justify-center"onClick={() => handleScrollToSection(`paintsection${index}`)}>
...
export default PaintingServiceComponent;
